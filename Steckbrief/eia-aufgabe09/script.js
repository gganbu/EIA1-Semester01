window.addEventListener("load", () => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        task_check_el.innerHTML = "<b class= 'fas fa-check'> </b>";
        ...
        input.value = "";
        document.querySelector("p").innerHTML = task_content_el.classList.length + " in total";
        ...
        /*task_check_el.addEventListener("click", (e) => {
          task_check_el.style.visibility = "hidden";
        });*/
    });
});
